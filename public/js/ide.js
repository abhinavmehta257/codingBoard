...
$(document).ready(function () {
    ...
    require(["vs/editor/editor.main", "monaco-vim", "monaco-emacs"], function (ignorable, MVim, MEmacs) {
        ...
        layout.on("initialised", function () {
         ...
         //remove closed editros from array

         layout.on("itemDestroyed", function(c){
            closedEditorId = c.componentName;
        
            editors = editors.filter((editor)=>editor.editorId != closedEditorId);
        
            // console.log("distroyed "+ closedEditorId);
            // console.log(c);
